...
![image-20220708124306444](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220708124306444.png)
...
![image-20220708164610193](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220708164610193.png)
...
<img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220708201221316.png" alt="image-20220708201221316" style="float:left;" />
...
![image-20220708214453902](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220708214453902.png)
...
![image-20220708215109480](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220708215109480.png)
...
![image-20220708215626435](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220708215626435.png)
...
![image-20220708220102342](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220708220102342.png)
...
![image-20220708220917267](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220708220917267.png)
...
<img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220708223250773.png" alt="image-20220708223250773" style="float:left;" />

**演示1. 读未提交之脏读**

设置隔离级别为未提交读：

![image-20220710193920008](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220710193920008.png)

脏读就是指当前事务就在访问数据，并且对数据进行了修改，而这种修改还没有提交到数据库中，这时，另外一个事务也访问了这个数据，然后使用了这个数据。

**演示2：读已提交**

![image-20220710194440101](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220710194440101.png)

**演示3. 不可重复读**

设置隔离级别为可重复读，事务的执行流程如下：

![image-20220710194144826](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220710194144826.png)

当我们将当前会话的隔离级别设置为可重复读的时候，当前会话可以重复读，就是每次读取的结果集都相同，而不管其他事务有没有提交。但是在可重复读的隔离级别上会出现幻读的问题。

**演示4：幻读**

![image-20220710194042096](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220710194042096.png)
