...
![image-20220622224124267](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220622224124267.png)

从结果可以看出，索引仍然是默认的升序

在MySQL 8.0版本中查看数据表ts1的结构，结果如下：

![image-20220622224205048](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220622224205048.png)
