...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161043752.jpeg)
## ❀写在最前（相关文章）
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161043171.png)
显示200ok即下载成功，然后我们安装；
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161043020.png)

```bash
#看一下/etc/yum.repos.d目录下多了一个zabbix.repo
ls /etc/yum.repos.d
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161043819.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161043132.png)
### 3、修改yum源为阿里源
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161043052.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161043409.png)

完了会生成一个repodata子目录

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161043093.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161043145.png)
...
MariaDB [(none)]> quit;
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161043964.png)
#### 7.5、导入初始架构和数据
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161042901.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161042667.png)
### 10、如果存在问题请检查日志
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161042754.png)

一路next step，到这个要输入密码，密码是123456


![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161042169.png)

下一步，需要你给这个监控起一个名字；

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161042545.png)


一直下一步,直到登录（默认的账号是：Admin   密码是：zabbix）

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161042952.png)

登录进入页面就可以了；

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161042611.png)
