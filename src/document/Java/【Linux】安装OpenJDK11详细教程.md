...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161355631.png)
### 下载完成之后上传服务器并解压
```bash
#将下载的包上传到服务器上
#将包放到/usr/local/目录
...
java --version
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412161355095.png)
