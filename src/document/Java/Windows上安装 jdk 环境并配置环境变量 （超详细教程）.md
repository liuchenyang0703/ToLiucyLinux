...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/db79e07b492e4ef6b680d89a400afcdb.jpeg)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/42360afe7bb040dead85065f17ae1faa.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/59db495b77c145b29ec5e7b7f2b9ac99.png)

><font color=red>这里注意，安装目录需要英文目录，不可以带中文。
>建议创建英文目录，然后在英文目录创建一个`jdk1.8`目录，一个`jre1.8`目录，后面配置环境变量需要用到。</font>

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/bca284b92cb04dda9202f4fd80a539a4.png)


安装完成之后会让你更改目标文件夹，也同样的修改到D盘就可以了；


![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/2e359dd919d74dbe956ca0524b4de6cd.png)

安装完成关闭即可；

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/c38ec7b9f7b448f98d7e8f97f4fe3751.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/8a4f25f0548e49e3a5547908eedc1938.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/bd129cce73b445fe9a72fc55432d5ca2.png)
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/bdd33104c9b24c5c8c406489e1575b09.png)

- 配置“CLASSPATH”变量，变量名为：“CLASSPATH ”。变量值为：【`.;%JAVA_HOME%\lib\dt.jar;%JAVA_HOME%\lib\tools.jar`】；并点击确定。


![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/dbafec249f114572a2549020d0c00c27.png)

- 配置“Path”变量，变量名为：“Path ”。变量值为：【`.;%JAVA_HOME%\bin;%JAVA_HOME%\jre\bin`】；并点击确定。
- 找到“Path”，点击编辑。

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/b4378ce61bdb4502be188abfd3700d6c.png)
- 点击新建

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/331834c33fa647f4864f944d613f7c2b.png)
- 新增变量值为：【`.;%JAVA_HOME%\bin;%JAVA_HOME%\jre\bin`】；并点击确定。

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/7225c237825e4ccbbec35dd078bf6fb5.png)
...
java -version
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/fce81d255d0a435fa910a5e592712593.png)
...
echo %PATH%
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/f51055f68dc7438c940b9f97fdbf5441.png)
