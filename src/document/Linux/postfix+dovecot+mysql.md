...
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141021162.png)
...
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141021287.png)
...
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141021818.png)

- 阿里云

![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141021673.png)
> 如果需要一个域名、两台服务器使用mail邮件服务，可以配置成mail1和mail2，这两台机器都需要一个`@A`、`@MX`、`mail2A`，`www`随便绑定主的哪台就用，用于部署网站等服务时用到；如下（阿里云、腾讯云等配置同样）：
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141021312.png)
...
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141021467.png)
...
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141021931.png)
...
```
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022417.png)
...
```
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022039.png)
...
```
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022163.png)
...
dovecot --version
```
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022514.png)
...
```
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022570.png)
...
ll | grep dovecot
```
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022678.png)
...
```
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022889.png)
...
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022420.png)
...
```
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022934.png)
...
ll /var/spool/ | grep mail
```
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022238.png)
...
* 新建邮箱
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022231.png)

* 选择其他邮箱

![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022328.png)

* 输入自己的email地址，也就是数据库里的邮件地址和密码；

![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022158.png)

* 选择`IMAP`，邮箱和密码是刚刚创建的用户信息，`IMAP`和`SMTP`都是域名`cs.com`；


![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022403.png)

![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022415.png)
...
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141022013.png)

收取邮件成功；

![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141023323.png)
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141023246.png)
![](https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202510141023585.png)
