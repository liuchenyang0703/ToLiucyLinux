...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181349279.png)
...
touch test-{1..20}.txt
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181349096.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181349032.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181349774.png)
...
rename txt cfg *
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181349954.png)
...
rename a A *
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181349402.png)
...
a
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181349197.png)
...
lcy
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181349305.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181349909.png)


**实例3：以空格为单位切割只要成功、失败两个字**

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348293.png)


```bash
cat a.txt | cut -d " " -f 1 | cut -c 4-5
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348814.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348977.png)
...
cat a.txt | sort
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348478.png)
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348564.png)
...
cat a.txt | sort -nr
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348166.png)
...
cat a.txt | sort -n
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348025.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348491.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348840.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348633.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348714.png)
...
cat a.txt | uniq -u
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348671.png)
...
uniq -d a.txt
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348016.png)

**实例4：忽略大小写去除<font color=red>相邻</font>相邻的重复行，并显示重复次数**

初始数据：

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348878.png)
...
cat a.txt | uniq -ic
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348817.png)
...
uptime | tee cs.txt
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348767.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348854.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348115.png)
...
echo "abc" | tr "abc" "ABC"
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348526.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181348399.png)
...
echo "aaaaaaaaabbbbbbbbbbbbbbbbbb1c2c3cc" | tr -d [a-z]
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347313.png)
...
echo "aaaaaaaabbbbbbbccccccc" | tr -s [a-z]
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347711.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347039.png)
...
tr [a-z] [A-Z] < a.txt
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347530.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347027.png)

**实例2：-a1还显示第一个文件中没有共同域的纪录，-a2则显示第二个**

文本内容：

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347225.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347491.png)
...
paste -d '=' - - < a.txt
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347549.png)
...
eee	EEE
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347778.png)
...
paste -d ':' a.txt b.txt
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347093.png)
...
paste -s a.txt b.txt
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347612.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347350.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347715.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347973.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347433.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347378.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347040.png)
...
vimdiff a.txt b.txt 
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181347165.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346963.png)
...
cat a.txt | xargs -d ":"
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346232.png)
...
rev a.txt
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346930.png)
...
shuf -i 1-10	
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346240.png)
...
shuf -n 5 -i 1-10
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346230.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346470.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346932.png)
...
sh -x cs.sh
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346476.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346644.png)

**<font color=gree>-v 一边执行脚本，一边打印脚本</font>**


![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346929.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346268.png)
...
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346464.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346580.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346126.png)

如果出现这个报错，可以在最后添加`-no-check-certificate`

![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346382.png)
...
./configure
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181346903.png)
...
bashdb --version
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412181345756.png)
