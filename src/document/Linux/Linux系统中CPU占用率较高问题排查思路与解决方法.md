...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412200949255.png)
...
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412200949184.png)2、找到该进程后，如何定位具体线程或代码呢，首先显示线程列表,并按照CPU占用高的线程排序：
...
```
显示结果如下：
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412200949311.png)
...
### 解决办法
1、根据top命令，shift+p，发现PID为41673的Java进程占用CPU高达250%，出现故障。
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412200949607.png)
2、根据pid查看他的进程看看是什么服务占用这么高

```bash
ps -ef |grep -v grep | grep 41673
```
![](https://gcore.jsdelivr.net/gh/liuchenyang0703/blog-images@main/images/202412200949313.png)
