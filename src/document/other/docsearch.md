...
![](https://vitepress.yiov.top/docsearch/docsearch-08.png)
...
![](https://vitepress.yiov.top/docsearch/docsearch-12.png)
...
![](https://vitepress.yiov.top/docsearch/docsearch-14.png)
...
![](https://vitepress.yiov.top/docsearch/docsearch-19.png)


这里 `Application ID` 和 `Search API Key` 是必须的两个参数


![](https://vitepress.yiov.top/docsearch/docsearch-20.png)
...
![](https://vitepress.yiov.top/docsearch/docsearch-21.png)
...
![](https://vitepress.yiov.top/docsearch/docsearch-22.png)

这里快速上手直接跳过

![](https://vitepress.yiov.top/docsearch/docsearch-23.png)

创建完成后，我们再设置 Setting 里查看

![](https://vitepress.yiov.top/docsearch/docsearch-24.png)

点击 `Applications`

![](https://vitepress.yiov.top/docsearch/docsearch-25.png)

点击 `Rename` 重命名一下，方便之后使用

![](https://vitepress.yiov.top/docsearch/docsearch-26.png)

我就改成 vitepress ，保存

![](https://vitepress.yiov.top/docsearch/docsearch-27.png)

点击改好的，回到面板界面

![](https://vitepress.yiov.top/docsearch/docsearch-28.png)


![](https://vitepress.yiov.top/docsearch/docsearch-29.png)


点击右下角 `Date Sources - Indices - Create Index` 创建索引

![](https://vitepress.yiov.top/docsearch/docsearch-30.png)

名字随意，一会要用！

![](https://vitepress.yiov.top/docsearch/docsearch-31.png)

点击右上角设置 `Settings - API Keys` ，查看关键Keys

![](https://vitepress.yiov.top/docsearch/docsearch-32.png)

![](https://vitepress.yiov.top/docsearch/docsearch-33.png)
...
![](https://vitepress.yiov.top/docsearch/docsearch-34.png)


我们在任意仓库（公开或私密） - 设置 - Secrets and variables - actions

![](https://vitepress.yiov.top/docsearch/docsearch-35.png)

密钥中，新增仓库密钥 `New repository secret`

![](https://vitepress.yiov.top/docsearch/docsearch-36.png)
...
![](https://vitepress.yiov.top/docsearch/docsearch-37.png)


![](https://vitepress.yiov.top/docsearch/docsearch-38.png)


这样2个密钥都添加好了

![](https://vitepress.yiov.top/docsearch/docsearch-39.png)


然后在仓库根目录新建一个文件

![](https://vitepress.yiov.top/docsearch/docsearch-40.png)
...
![](https://vitepress.yiov.top/docsearch/docsearch-41.png)

这样就可以了

![](https://vitepress.yiov.top/docsearch/docsearch-42.png)


然后在仓库，点击 `Actions` - `set up a workflow yourself `新建一个工作流

![](https://vitepress.yiov.top/docsearch/docsearch-43.png)

命名为 `docsearch.yml` ，复制粘贴下面的工作流代码，提交

![](https://vitepress.yiov.top/docsearch/docsearch-44.png)
...
![](https://vitepress.yiov.top/docsearch/docsearch-45.png)

我们静等工作流跑完，如果失败，就是你密钥没有正确配置

![](https://vitepress.yiov.top/docsearch/docsearch-46.png)

看一下Algolia已经有数据了

![](https://vitepress.yiov.top/docsearch/docsearch-47.png)
...
需要对json文件进行修改，以下是仅单独增加一个 [Markdown](https://vitepress.yiov.top/markdown.html) 页面分类的简单案例
...
![](https://vitepress.yiov.top/docsearch/docsearch-49.png)
