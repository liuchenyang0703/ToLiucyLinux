...
const paypalLink = "/assets/image/Reward.html";
const qrCodes = reactive({
  alipay_donate: "/assets/image/AliPayQR.jpg",
  alipay_donate_link: "https://qr.alipay.com/fkx10720tbvl7vbt30mmad4",
  wechat_donate: "/assets/image/WeChanSQ.jpg",
});
...
#drinks-icons {
  //   background: no-repeat center center url(image/text.png);
}
.drinks-button > div {
  position: absolute;
  top: 0;
...
#github-box {
  ...
  position: absolute;
  top: calc(50% - 16px);
  background: no-repeat center center url(/assets/image/github.svg);
