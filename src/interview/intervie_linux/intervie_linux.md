...
## 24、df -h 发现磁盘空间满了，但是任凭各个文件目录下  du -sh \* 也找不到大文件，怎么解决  
...
## 31、如何使用 grep 统计匹配的行数？  
答：grep -c "pattern" file.txt

## 32、如何使用 awk 打印文件的某一列？  
答：awk '{ print $1 }' file.txt

## 33、如何使用 awk 计算某一列的总和？  
