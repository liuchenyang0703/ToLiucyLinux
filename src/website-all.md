...
highlights:
  ...
  - header: 开源镜像
    features:
      - title: 华为云开源镜像站
        icon: huaweiyun
        details: 提供主流开发语言组件、操作系统、常用工具和库等镜像。
        link: https://mirrors.huaweicloud.com/home

      - title: 阿里巴巴开源镜像站
        icon: https://img.alicdn.com/tfs/TB1_ZXuNcfpK1RjSZFOXXa6nFXa-32-32.ico
        details:  提供极速全面稳定的系统镜像服务。
      ...
      - title:  兰州大学开源软件镜像站
        ...
        details: 提供主流 GNU/Linux 发行版以及开源、自由软件镜像。
  ...
  - header: 代码托管平台
    features:
      - title: Github 官网
        ...
        details: Github代码仓库，是一个面向开源及私有软件项目的托管平台。
        link: https://github.com/

      - title: Gitee 码云官网
        icon: https://gitee.com/favicon.ico
        details: 基于 Git 的代码托管和研发协作平台。
        link: https://gitee.com/

      - title: GitLab 官网
        icon: https://about.gitlab.com/nuxt-images/ico/favicon.ico
        details: 一个DevOps平台，一个方便软件开发的强大完整应用。
