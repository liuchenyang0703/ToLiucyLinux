...
<span class="line"><span style="color:#6A9955;">  #tcp_nopush     on;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6A9955;">  #keepalive_timeout  0;</span></span>
<span class="line"><span style="color:#DCDCAA;">  keepalive_timeout</span><span style="color:#B5CEA8;"> 65</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6A9955;">  #gzip  on;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#DCDCAA;">  server</span><span style="color:#CE9178;"> {</span></span>
<span class="line"><span style="color:#DCDCAA;">    listen</span><span style="color:#B5CEA8;"> 80</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#DCDCAA;">    server_name</span><span style="color:#CE9178;"> test.top</span><span style="color:#CE9178;"> www.test.top</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6A9955;">    # HTTP 重定向到 HTTPS</span></span>
<span class="line"><span style="color:#C586C0;">    return</span><span style="color:#B5CEA8;"> 301</span><span style="color:#CE9178;"> https://</span><span style="color:#9CDCFE;">$host$request_uri</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#D4D4D4;">  }</span></span>
<span class="line"></span>
<span class="line"><span style="color:#DCDCAA;">  server</span><span style="color:#CE9178;"> {</span></span>
<span class="line"><span style="color:#DCDCAA;">    listen</span><span style="color:#B5CEA8;"> 443</span><span style="color:#CE9178;"> ssl</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#DCDCAA;">    server_name</span><span style="color:#CE9178;"> test.top</span><span style="color:#CE9178;"> www.test.top</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6A9955;">    # SSL 配置</span></span>
<span class="line"><span style="color:#DCDCAA;">    ssl_certificate</span><span style="color:#CE9178;"> /usr/local/nginx/conf/ssl/test.top.pem</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#DCDCAA;">    ssl_certificate_key</span><span style="color:#CE9178;"> /usr/local/nginx/conf/ssl/test.top.key</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#DCDCAA;">    ssl_protocols</span><span style="color:#CE9178;"> TLSv1.2</span><span style="color:#CE9178;"> TLSv1.3</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#DCDCAA;">    ssl_ciphers</span><span style="color:#CE9178;"> &#39;TLS_AES_128_GCM_SHA256:TLS_AES_256_GCM_SHA384:ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES128-GCM-SHA256&#39;</span><span style="color:#D4D4D4;">;</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A9955;">    # 设置错误页面</span></span>
<span class="line"><span style="color:#DCDCAA;">    error_page</span><span style="color:#B5CEA8;"> 404</span><span style="color:#CE9178;"> /404.html</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#DCDCAA;">    error_page</span><span style="color:#B5CEA8;"> 500</span><span style="color:#CE9178;"> /500.html</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#DCDCAA;">    location</span><span style="color:#CE9178;"> =</span><span style="color:#CE9178;"> /404.html</span><span style="color:#CE9178;"> {</span></span>
<span class="line"><span style="color:#DCDCAA;">      root</span><span style="color:#CE9178;"> /usr/local/nginx/html</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#DCDCAA;">      internal</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#D4D4D4;">    }</span></span>
<span class="line"></span>
<span class="line"><span style="color:#DCDCAA;">    location</span><span style="color:#CE9178;"> =</span><span style="color:#CE9178;"> /500.html</span><span style="color:#CE9178;"> {</span></span>
<span class="line"><span style="color:#DCDCAA;">      root</span><span style="color:#CE9178;"> /usr/local/nginx/html</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#DCDCAA;">      internal</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#D4D4D4;">    }</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6A9955;">    # 定义项目根目录</span></span>
<span class="line"><span style="color:#DCDCAA;">    root</span><span style="color:#CE9178;"> /usr/local/nginx/html</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6A9955;">    # 默认访问 项目1 【如果不想用项目1，也可以自定义其他项目】</span></span>
<span class="line"><span style="color:#DCDCAA;">    location</span><span style="color:#CE9178;"> /</span><span style="color:#CE9178;"> {</span></span>
<span class="line"><span style="color:#DCDCAA;">      try_files</span><span style="color:#9CDCFE;"> $uri</span><span style="color:#9CDCFE;"> $uri</span><span style="color:#CE9178;">/</span><span style="color:#CE9178;"> /项目1/index.html</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#6A9955;">      #			root   html;</span></span>
<span class="line"><span style="color:#6A9955;">      #			index  index.html index.htm;</span></span>
<span class="line"><span style="color:#D4D4D4;">    }</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6A9955;">    # 项目1 项目</span></span>
<span class="line"><span style="color:#DCDCAA;">    location</span><span style="color:#CE9178;"> /项目1</span><span style="color:#CE9178;"> {</span></span>
<span class="line"><span style="color:#DCDCAA;">      alias</span><span style="color:#CE9178;"> /usr/local/nginx/html/项目1</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#DCDCAA;">      try_files</span><span style="color:#9CDCFE;"> $uri</span><span style="color:#9CDCFE;"> $uri</span><span style="color:#CE9178;">/</span><span style="color:#CE9178;"> /项目1/index.html</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#D4D4D4;">    }</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6A9955;">    # 项目2 项目</span></span>
<span class="line"><span style="color:#DCDCAA;">    location</span><span style="color:#CE9178;"> /项目2</span><span style="color:#CE9178;"> {</span></span>
<span class="line"><span style="color:#DCDCAA;">      alias</span><span style="color:#CE9178;"> /usr/local/nginx/html/项目2</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#DCDCAA;">      try_files</span><span style="color:#9CDCFE;"> $uri</span><span style="color:#9CDCFE;"> $uri</span><span style="color:#CE9178;">/</span><span style="color:#CE9178;"> /项目2/index.html</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#D4D4D4;">    }</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6A9955;">    # 项目3 项目</span></span>
<span class="line"><span style="color:#DCDCAA;">    location</span><span style="color:#CE9178;"> /项目3</span><span style="color:#CE9178;"> {</span></span>
<span class="line"><span style="color:#DCDCAA;">      alias</span><span style="color:#CE9178;"> /usr/local/nginx/html/项目3</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#DCDCAA;">      try_files</span><span style="color:#9CDCFE;"> $uri</span><span style="color:#9CDCFE;"> $uri</span><span style="color:#CE9178;">/</span><span style="color:#CE9178;"> /项目3/index.html</span><span style="color:#D4D4D4;">;</span></span>
<span class="line"><span style="color:#D4D4D4;">    }</span></span>
<span class="line"><span style="color:#D4D4D4;">  }</span></span>
